...
const calcDuration = pair => {
  ...
  const departure_minute =
    parseInt(departure.slice(0, 2)) * 60 + parseInt(departure.slice(3, 5));
  let arrival_minute =
    parseInt(arrival.slice(0, 2)) * 60 + parseInt(arrival.slice(3, 5));
  ...
  return (
    String(duration_hour).padStart(2, '0') +
    ':' +
